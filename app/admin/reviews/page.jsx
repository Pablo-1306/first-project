...
import { Box, Button, Container, Divider, Typography, IconButton, useTheme } from "@mui/material";
                ...
                {reviews.map(review => (
                    <Box key={review.id}>
                        <Grid container sx={{mt: 6, mb: 3}}>
                            ...
                            <Grid size={{md: 2}} display='flex' justifyContent='center' alignItems='center'>
                                <IconButton aria-label="delete" size="large"
                                    onClick={() => deleteReview(review.id)}
                                >
                                    <DeleteOutlinedIcon fontSize="inherit" sx={{color: theme.palette.secondary.main}} />
                                </IconButton>
                            </Grid>
