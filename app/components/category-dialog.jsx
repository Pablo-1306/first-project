...
export default function CategoryDialog({ open, setOpen, editMode, category, setCategory, categories, addCategory, editCategory, setAlert, setOpenAlert }) {
    ...
    const saveCategory = () => {
        ...
        } else { // If editMode is false, add a new category
